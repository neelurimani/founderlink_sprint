...
public class UserProfileController {
    ...
    public ResponseEntity<UserProfileResponse> create(@Valid @RequestBody UserProfileUpsertRequest request) {
    ...
    public ResponseEntity<UserProfileResponse> createFounder(@Valid @RequestBody FounderProfileUpsertRequest request) {
    ...
    public ResponseEntity<UserProfileResponse> createCoFounder(@Valid @RequestBody CoFounderProfileUpsertRequest request) {
    ...
    public ResponseEntity<UserProfileResponse> createInvestor(@Valid @RequestBody InvestorProfileUpsertRequest request) {
    ...
    public UserProfileResponse get(@PathVariable("id") Long id) {
        return userProfileUseCase.getByUserId(id);
    }

    @GetMapping
    @Operation(summary = "List user profiles with pagination")
    public PaginatedResponse<UserProfileResponse> list(
            @RequestParam(defaultValue = "0") @Min(0) int page,
            @RequestParam(defaultValue = "10") @Min(1) @Max(100) int size) {
        return PaginatedResponse.from(userProfileUseCase.list(page, size));
    }

    @PutMapping("/{id}")
    @Operation(summary = "Update user profile by user id")
    public UserProfileResponse update(@PathVariable("id") Long id, @Valid @RequestBody UserProfileUpsertRequest request) {
        return userProfileUseCase.update(id, request);
    }

    @PutMapping("/founders/{id}")
    @Operation(summary = "Update founder profile by user id")
    public UserProfileResponse updateFounder(@PathVariable("id") Long id, @Valid @RequestBody FounderProfileUpsertRequest request) {
    ...
    public UserProfileResponse updateCoFounder(@PathVariable("id") Long id, @Valid @RequestBody CoFounderProfileUpsertRequest request) {
    ...
    public UserProfileResponse updateInvestor(@PathVariable("id") Long id, @Valid @RequestBody InvestorProfileUpsertRequest request) {
